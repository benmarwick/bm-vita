\message{ !name(bm-vita-master.tex)}%%% A template to produce a nice-looking Curriculum Vitae.
...
\message{ !name(bm-vita-master.tex) !offset(-3) }
...
%%%%%%%%  UOW details  
 \href{http://cas.uow.edu.au/index.html/}{Centre for Archaeological Science}\\ University of Wollongong  \\ \vspace{-0.05in} New South Wales \textsc{wa} 2500}  
...
\message{ !name(bm-vita-master.tex) !offset(-248) }
