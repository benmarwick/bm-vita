...
<<<<<<< HEAD
\ind Shafizadeh, S., Khaki, M., and Marwick, B. (2025). Between Nomads and Settlers: A Quantitative Analysis of Lithic Assemblages from Tula’i (Tuleii), Zagros, Iran. \textit{Lithic Technology}, 1–17

\ind Ruan, Q.. H. Li, B. Marwick, M. Peresani, M. Moncel, P. Xiao, H. Monod, B. Li, and D. Delpian (2025). Reply to Bourguignon et al.: Convergence is a plausible hypothesis for Quina technology in East Asia, \textit{Proceedings of the National Academy of Science} 122 (40) e2519000122,

\ind Marwick, B. (2025). Is archaeology a science? Insights and imperatives from 10,000 articles and a year of reproducibility reviews. \textit{Journal of Archaeological Science}, 180, 106281.

\ind Huan, F., Yang, S., Marwick, B. et al. (2025). Lithic miniaturization in South China since the terminal Pleistocene: A multivariate analysis of lithic reduction from Fodongdi, Fulin and Xiqiaoshan. \textit{Journal of Geographic Science} 

\ind Ruan, Q., H. Li, P. Xiao, B. Li, H. Monod, A. Sumner, K. Zhao, J. Liu, Z. Jia, C. Wang, A. Fan, M. Moncel, B. Marwick, M. Peresani, Y. Wang, F. Chen, & D. Delpiano (2025) Quina lithic technology indicates diverse Late Pleistocene human dynamics in East Asia \textit{Proceedings of the National Academy of Science} 122 (14) e2418029122

\ind Hongliang Lu, Xinglong Zhang, Yaping Qin, Guobing Yang, Yun Chen, Pengchen Xu, Ming Huang, Ming Jiang, Ben Marwick & Yue Hu (2024) New Evidence of Human Occupation in Southwest China Since 44,800 Years ago, \textit{Lithic Technology}

\ind Marwick B. (2024) Introducing the Associate Editor of Reproducibility. \textit{Advances in Archaeological Practice}. 2024;12(2):61-62.

\ind Matzig D. N., Marwick B., Riede F. and Warnock R. C. M. (2024) A macroevolutionary analysis of European Late Upper Palaeolithic stone tool shape using a Bayesian phylodynamic framework. \textit{Royal Society Open Science} 11240321

\ind DiCiro, A., N. Mitchell, and B. Marwick (2024). Everything is a Deposit: An interview with pioneering geoarchaeologist Julie K. Stein. \textit{Bulletin of the History of Archaeology}

\ind Hu, Y., Marwick, B., Lu, H. et al. (2024) Lithic technologies at Guanyindong cave, Southwest China: diversity and innovation during the Chinese Middle Palaeolithic. \textit{Archaeological and Anthropological Sciences} 16, 119

\ind Stoudt S, Jernite Y, Marshall B, Marwick B, Sharan M, et al. (2024) Ten simple rules for building and maintaining a responsible data science workflow. \textit{PLOS Computational Biology} 20(7): e1012232.
=======
...
>>>>>>> 8aafe8f6fd4c98f5585a1b45c01ba25b53e282b0
